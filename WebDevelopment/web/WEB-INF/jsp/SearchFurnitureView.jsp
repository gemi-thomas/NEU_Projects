<%-- 
    Document   : SearchFurnitureView
    Created on : Dec 10, 2019, 1:54:12 PM
    Author     : 16173
--%>
...
<html>
    ...
    <body>
        ...
        <br/>
        <br/>
        <h1> Search Results for Furniture</h1>
        
        <c:forEach items="${requestScope.data}" var="e" >
               <br>
                    <img src="${e.uploadImage.toArray()[0]}" width="400" height="300"/><br/>
                    <a class="title"  href="singlepost.htm?type=furniture&postid=${e.postID}&title=${e.title}"> View This Post</a>
               <br>
       ...
       <c:forEach var="i" begin="1" end="${requestScope.numpg}">
           ...
           <a class="btnbox" href="postview.htm?category=furniture&pgid=${i}" />${i}</a>
