 ...
 * @author gemi
 */
public class AvgTimeofUsagePerMonthReducer extends Reducer<RiderKey, RiderWritable, RiderKey, RiderWritable>{
    
    protected void reduce(RiderKey key, Iterable<RiderWritable> values, Context context) throws IOException, InterruptedException {
